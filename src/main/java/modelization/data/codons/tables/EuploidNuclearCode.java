...
/*  68 */     this.cysteine = EnumSet.of(Codon.TGT, Codon.TGC, Codon.TGA);
/*  69 */     this.tryptophan = EnumSet.of(Codon.TGG);
...
/*  73 */     this.arginine.add(Codon.AGA);
/*  74 */     this.arginine.add(Codon.AGG);
 ...
 * Qualified Name:     metapiga.modelization.data.codons.tables.EuploidNuclearCode
