...
/*     */   {
/*  12 */     this.stopCodons = EnumSet.of(Codon.TGA);
/*     */ 
...
/*  61 */     this.glutamine = EnumSet.of(Codon.CAA, Codon.CAG, Codon.TAA, Codon.TAG);
 ...
 * Qualified Name:     metapiga.modelization.data.codons.tables.CDHNuclearCode
